--
INSERT INTO `db_py_admin`.`sys_admin_role` (`id`, `rolename`, `permission`, `sort`, `status`, `utc_created_at`) VALUES ('1', '超级管理员', '[]', '1', '1', '2018-03-05 07:27:44.537284');
INSERT INTO `db_py_admin`.`sys_admin_role` (`id`, `rolename`, `permission`, `sort`, `status`, `utc_created_at`) VALUES ('2', '默认角色', '[]', '20', '1', '2018-05-02 02:22:47.143951');

--
INSERT INTO `db_py_admin`.`sys_admin_user` (`id`, `role_id`, `password`, `username`, `mobile`, `email`, `permission`, `login_count`, `last_login_ip`, `utc_last_login_at`, `status`, `utc_created_at`) VALUES ('0', '0', 'pbkdf2_sha256$100000$lTbYoXJUOk8dylGe$/cnEo7M9IiwGs9P0vDYUR9Q6++m8uDRTt1fwz10CZeo=', 'admin', '13692177081', 'admin@admin.com', '[]', '40', '127.0.0.1', '2018-06-16 23:53:08.401267', '1', '2018-02-28 09:15:10.012341');
